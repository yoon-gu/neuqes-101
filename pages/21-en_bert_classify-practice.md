...
```text
   ...
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━ 36.6/50.1 MB 268.7 MB/s eta 0:00:01
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸ 50.1/50.1 MB 279.8 MB/s eta 0:00:01
...
7.173933       7.221153         3
MLM eval loss:        7.2212
MLM eval perplexity:  1368.07
...
1      0.689583       0.687573         0.494000  0.488821   0.993802  0.655313  0.666845
2      0.667524       0.661433         0.632000  0.606618   0.681818  0.642023  0.680585
Classification fine-tune done in 0.2 min
mean train loss: 0.6836
random baseline (ln 2): 0.6931
```

**결과 해석**

평균 train loss 0.6836 로 random baseline 0.6931 에서 아주 조금만 내려왔습니다. 작은 본체 + 작은 사전학습 + 2 epoch 라는 toy 셋업에서 분류 경계가 *겨우 잡히기 시작한* 정도임을 시사합니다.
...
|=========================================+========================+======================|
|   0  Tesla T4                       Off |   00000000:00:04.0 Off |                    0 |
| N/A   60C    P0             45W /   70W |     797MiB /  15360MiB |     33%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
|        ID   ID                                                               Usage      |
|=========================================================================================|
|    0   N/A  N/A            1558      C   /usr/bin/python3                        794MiB |
+-----------------------------------------------------------------------------------------+
```
