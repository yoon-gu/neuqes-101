...
세 줄을 한자리에 놓으니 그림이 분명해집니다. Ch 26의 자기회귀는 같은 데이터로 멀쩡한 이야기를 써냈고, 표준 MLM도 고정-t accuracy 0.469로 정상 학습에 성공했습니다. 데이터가 빈약하거나, 모델이 작거나, 토크나이저가 망가졌다면 이 둘도 함께 무너졌어야 합니다. 그런데 둘 다 잘 됐습니다. 오직 순진한 diffusion만 0.081로 collapse했습니다.
