...
1500 step 학습이 약 0.91분에 끝났고, 누적 평균 `train_loss`가 random baseline 8.29에서 4.46까지 내려갔습니다. 번역체 한국어라 영어 챕터(Ch 24, 약 3.7)보다 다소 높지만(학습률도 `3e-4 → 5e-4`로 달라 언어 차이만의 효과는 아님) baseline에서 절반 가까이 떨어진 정상 수렴이며, peak VRAM 66 MiB로 T4에 매우 여유롭습니다.
