...
- [06-1. 실습 2: `OneVsRestClassifier` (이번엔 argmax 없이)](06-sklearn_multilabel-practice.md)
- [06-2. 해부: multi-label 평가 지표](06-sklearn_multilabel-anatomy.md)
- [06-3. 변형: 라벨별 임계값(threshold) 변경](06-sklearn_multilabel-variation.md)
- [06-4. 정리와 FAQ](06-sklearn_multilabel-wrapup.md)
