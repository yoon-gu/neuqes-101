...
5,000 × 10,000 = 5천만 칸 중 실제로 채워진 건 40만 칸뿐(문서당 평균 약 81종의 서로 다른 단어 — 같은 단어가 여러 번 나와도 한 칸)이라 99.19%가 0입니다. 이렇게 0이 압도적이라 dense 배열로 두면 메모리 낭비가 커서, sklearn 은 0이 아닌 칸만 저장하는 희소 행렬을 씁니다.
