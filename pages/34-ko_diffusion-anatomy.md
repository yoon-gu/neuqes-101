순진한 이식은 명백히 망가졌습니다. 생성된 문장은 `",. 함께 하루, 큰.!."`처럼 구두점과 고빈도 파편만 흩어진 모양이었습니다. 그런데 "망가졌다"는 인상만으로는 고칠 수가 없습니다. 무엇이 어디서 어떻게 무너졌는지를 숫자로 짚어야 다음 수를 둘 수 있습니다. 그래서 이번 해부는 세 단계로 진행합니다. 먼저 붕괴의 증상을 숫자로 확정하고, 다음으로 "왜 안 되나"를 따라가다 막다른 길에 부딪혀 보고, 마지막으로 질문을 뒤집어 "그럼 무엇이 되는가"를 대조군으로 찾아냅니다.
