...
```text
   ...
   ━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━ 21.4/50.1 MB 216.7 MB/s eta 0:00:01
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸ 50.1/50.1 MB 250.0 MB/s eta 0:00:01
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸ 50.1/50.1 MB 250.0 MB/s eta 0:00:01
...
한국어 Wikipedia paragraphs 는 *제한 50-2000자 필터링* 으로 평균 문장 길이가 일정 (수십 자-수백 자). 5,000 paragraphs 이 `block_size=128` 로 잘리면 train 3,924 블록 (약 502K 토큰), eval 500 paragraphs 는 429 블록으로 정리됩니다 — 바로 아래 셀 출력에서 확인할 수 있고, `seed` 와 길이 필터가 고정이라 재실행해도 같은 값입니다. NSMC 한 줄 리뷰보다 길고 Yelp 보다는 짧은 중간 수준 — 일반 도메인 코퍼스다운 균형.
...
**관찰** — vocab 이 약 32,000 (Ch 20 의 30,522 보다 약간 큼) 이라 임베딩 테이블이 살짝 더 큽니다. 그래도 본체 구조는 동일 — encoder body 약 3.2M + 임베딩 약 8.2M (합계 약 11.5M) 수준의 작은 BERT.
...
|=========================================+========================+======================|
|   0  Tesla T4                       Off |   00000000:00:04.0 Off |                    0 |
| N/A   54C    P0             73W /   70W |    3449MiB /  15360MiB |     58%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
|        ID   ID                                                               Usage      |
|=========================================================================================|
|    0   N/A  N/A            1687      C   /usr/bin/python3                       3446MiB |
+-----------------------------------------------------------------------------------------+
```
