...
임계값을 0.3에서 0.7로 올릴수록 precision은 0.68→0.97로 오르고 recall은 0.99→0.57로 떨어집니다 — 본문에서 예고한 trade-off가 숫자로 드러납니다. 균형 데이터라 accuracy와 F1은 0.5 부근에서 가장 높지만, 도메인이 precision이나 recall 한쪽을 더 중시한다면 0.5가 최선이 아닐 수 있습니다.
