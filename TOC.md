...
* [12. BERT 다중 클래스 분류 (Multi-class & CE)](pages/12-bert_multiclass.md)
  * [12-1. 실습: DistilBERT 5클래스 분류](pages/12-bert_multiclass-practice.md)
  * [12-2. 정리와 FAQ](pages/12-bert_multiclass-wrapup.md)
* [13. BERT 다중 라벨 분류 (Multi-label & Per-label BCE)](pages/13-bert_multilabel.md)
  * [13-1. 실습: per-label BCE 다중 라벨 분류](pages/13-bert_multilabel-practice.md)
...
* [17. 한국어 BERT 다중 라벨 분류 (Korean Multi-label Classification)](pages/17-ko_multilabel.md)
  * [17-1. 실습: 한국어 다중 라벨 분류](pages/17-ko_multilabel-practice.md)
...
* [18. 한국어 BERT 보조 손실 (Korean Auxiliary Loss)](pages/18-ko_auxiliary.md)
  * [18-1. 실습: 한국어 보조 손실 학습](pages/18-ko_auxiliary-practice.md)
...
* [19. 토크나이저 직접 학습 (Tokenizer Training)](pages/19-tokenizer_training.md)
  * [19-1. 실습: BPE·WordPiece 토크나이저 직접 학습](pages/19-tokenizer_training-practice.md)
...
* [20. 작은 BERT 사전학습 (English MLM Pretraining)](pages/20-en_bert_pretrain.md)
  * [20-1. 실습: 작은 BERT MLM 사전학습](pages/20-en_bert_pretrain-practice.md)
...
* [25. GPT-2 계속 사전학습 (Continual Pretraining)](pages/25-gpt2_continual_pretrain.md)
  * [25-1. 실습: gpt2 계속 사전학습](pages/25-gpt2_continual_pretrain-practice.md)
...
* [26. 한국어 작은 GPT 사전학습 (TinyStories-Korean Causal LM)](pages/26-ko_tiny_gpt.md)
  * [26-1. 실습: 한국어 작은 GPT 사전학습](pages/26-ko_tiny_gpt-practice.md)
...
* [27. KoGPT2 계속 사전학습 (Korean Continual Pretraining)](pages/27-ko_gpt2_continual_pretrain.md)
  * [27-1. 실습: KoGPT2 계속 사전학습](pages/27-ko_gpt2_continual_pretrain-practice.md)
...
* [28. KoGPT2 SFT (Instruction Tuning)](pages/28-sft.md)
  * [28-1. 실습: KoGPT2 instruction tuning (SFT)](pages/28-sft-practice.md)
...
* [34. 작은 diffusion LM으로 한국어 동화 만들기 — 80/10/10 마스킹](pages/34-ko_diffusion.md)
